    ...
    <>
      ...
      <nav className='navbar'>
        ...
        <div className='flex items-center gap-3 md:gap-6 ml-auto'>
          ...
          <Link to='/editor' className='hidden md:flex gap-2 link hover:rounded-2xl'>
            <i className='fi fi-rr-file-edit fill: #ea580c;'></i>
            <p>Write</p>
          </Link>

          <Link className='btn-docs py-2' to='/signin'>
            Sign In
          </Link>
